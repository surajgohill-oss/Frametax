...
**Canonical entry point:** `app/services/canonical_evaluation.py::evaluate_project()`. `ENGINE_VERSION = "canonical-1.81.0"`, `STACKING_RULES_VERSION = "1.4.0"` (`app/optimization/stacking_rules.py`).
