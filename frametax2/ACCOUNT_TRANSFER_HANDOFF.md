...
**Canonical entry point:** `app/services/canonical_evaluation.py::evaluate_project()`. `ENGINE_VERSION = "canonical-1.81.0"` (unchanged since `64e72b97` -- neither of the two passes below changed pricing/qualification economics), `STACKING_RULES_VERSION = "1.4.0"` (`app/optimization/stacking_rules.py`).
