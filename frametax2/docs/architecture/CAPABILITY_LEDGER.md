...
1. **CBA-002 remainder** — see above: the typed condition-kind vocabulary itself is DONE and tested; wiring its outcomes into the qualification/Recommended-admission gate (Section 4 of the governing spec) is not yet done.
