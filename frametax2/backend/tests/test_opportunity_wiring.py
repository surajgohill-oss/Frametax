...
async def test_baselines_unchanged_after_opportunity_reconnection(db: AsyncSession):
    ...
    assert round(lu_baseline["npc_with_adjustments_usd"], 2) == 3812823.20  # CBA-009 Part 19-21: LU's own persisted 100% contingency-utilization project election (migration 0068) reproduces the historical $3,057,794.90 baseline through the generic pipeline
