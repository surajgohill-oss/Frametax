...
def upgrade() -> None:
    ...
    op.bulk_insert(rules_table, [
        ...
        },
        {
            ...
            "threshold_text": "california_registered_entity",
            "fail_action": "disqualify",
            "description": "Production company must be a California-registered entity to claim credit",
            "source_document_id": SRC_CA_ID,
            "source_page": None,
            "source_excerpt": None,
            "statutory_reference": "CA Gov Code § 17053.98; CFC program guidelines",
            "confidence_tier": "PARSED",
            "created_at": NOW,
            "updated_at": NOW,
        },
        {
            ...
            "program_id": la_prog,
            "rule_type": "minimum_qualified_spend",
            "threshold_numeric": 300_000,
            "threshold_text": None,
            "fail_action": "disqualify",
            "description": "Minimum $300,000 in Louisiana-certified production expenditures required",
            "source_document_id": SRC_LA_ID,
            "source_page": None,
            "source_excerpt": None,
            "statutory_reference": "LA RS § 47:6007",
            "confidence_tier": "PARSED",
            "created_at": NOW,
            "updated_at": NOW,
        },
        {
            ...
            "rule_type": "required_entity_type",
            "threshold_numeric": None,
            "threshold_text": "state_certified_production",
            "fail_action": "disqualify",
            "description": "Production must be a state-certified motion picture production",
            "source_document_id": SRC_LA_ID,
            "source_page": None,
            "source_excerpt": None,
            "statutory_reference": "LA RS § 47:6007; Louisiana Entertainment certification",
            "confidence_tier": "PARSED",
            "created_at": NOW,
            "updated_at": NOW,
        },
