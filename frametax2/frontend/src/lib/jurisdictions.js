...
export const JURISDICTION_COORDS = {
  ...
  "CA-BC": { lat: 49.28, lng: -123.12, name: "Vancouver" },
  "CA-NB": { lat: 46.56, lng: -66.46, name: "New Brunswick" },
  "CA-NL": { lat: 47.56, lng: -52.71, name: "Newfoundland" },
  "CA-NS": { lat: 44.65, lng: -63.58, name: "Nova Scotia" },
  "CA-ON": { lat: 43.65, lng: -79.38, name: "Toronto" },
  "CA-QC": { lat: 45.5, lng: -73.57, name: "Montreal" },
  ...
  "US-OR": { lat: 45.52, lng: -122.68, name: "Portland" },
  ...
  "US-TX": { lat: 30.27, lng: -97.74, name: "Austin" },
  "US-VA": { lat: 37.54, lng: -77.44, name: "Virginia" },
  "US-WA": { lat: 47.61, lng: -122.33, name: "Seattle" },
