  ...
  return (
    <aside className="fixed left-0 top-0 h-screen w-56 bg-[#161b27] border-r border-[#2a3145] flex flex-col z-10">
      <div className="flex items-center gap-2 px-4 py-5 border-b border-[#2a3145]">
        ...
        <div>
          <p className="text-sm font-semibold leading-tight text-slate-100">LA Concert</p>
          <p className="text-xs text-slate-400 leading-tight">Watchlist Tracker</p>
        </div>
      </div>
      ...
      <div className="p-3 border-t border-[#2a3145] text-xs text-slate-500 px-4">
        <p>Personal use · LA only</p>
      </div>
    </aside>
  );
}
