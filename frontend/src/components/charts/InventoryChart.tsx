...
export function InventoryChart({ data, height = 220 }: { data: any[]; height?: number }) {
  ...
  if (!chartData.length)
    return <div style={{ height }} className="flex items-center justify-center text-slate-500 text-sm">No inventory history yet.</div>;
  return (
